= ViSH
Virtual Science Hub, a network for exploring science now.
This branch intends to clean ViSH views to use upstream bootstrap

{<img src="https://secure.travis-ci.org/ging/vish.png" />}[http://travis-ci.org/ging/vish]
{<img src="https://gemnasium.com/ging/vish.png" />}[https://gemnasium.com/ging/vish]
...
{VISH}[http://github.com/ging/vish] is based on
{Social Stream}[http://github.com/ging/social_stream] which provides a robust and flexible core with social networking features and activity streams for building websites.

= Discussion

Feel free to raise an issue or send us a message at github[https://github.com/ging/vish].
