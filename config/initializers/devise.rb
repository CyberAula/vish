...
Devise.setup do |config|
  ...
  config.mailer_sender = Vish::Application.config.APP_CONFIG["no_reply_mail"]
  ...
  config.http_authentication_realm = "ViSH"
  ...
  # config.pepper = "b1a37da33fc569ff66a2c7d6a602c82463ef196fe2b913428c4ebc78433048a37edae25c099d2ccffc7cb364014f144e7380f665839f8361b6aa6c96020ca1b7"
  ...
  #config.omniauth :linkedin, "NUMBER", "KEY"

  #config.omniauth :facebook, "NUMBER","KEY"

  #config.omniauth :twitter, "NUMBER","KEY"
