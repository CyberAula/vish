SocialStream.setup do |config|
  ...
  #
  config.objects = [:post, :comment, :document, :link, :excursion, :embed, :writing, :swf, :officedoc, :event, :category, :zipfile, :scormfile, :imscpfile, :webapp, :workshop, :course,:ediphy_document]
  ...
  # 
  config.quick_search_models = [:excursion, :user, :picture, :video, :audio, :swf, :officedoc, :document, :category, :embed, :writing, :link, :event, :zipfile, :scormfile, :imscpfile, :webapp, :workshop, :ediphy_document]
  config.extended_search_models = [:excursion, :user, :event, :category, :workshop, :ediphy_document, { :resource => [ :picture, :video, :audio, :swf, :officedoc, :document, :embed, :writing, :link, :zipfile, :scormfile, :imscpfile, :webapp ] } ]
