...
(function() {
 ...
 (CKEDITOR.env.hc ? '&#9660;' : CKEDITOR.env.air ? '&nbsp;' : '') +
  ...
  '</span>';
    ...
    let rcomboTpl = CKEDITOR.addTemplate('combo', template);
    ...
    CKEDITOR.ui.richCombo = CKEDITOR.tools.createClass({
        $: function(definition) {
            ...
            let panelDefinition = this.panel || {};
            delete this.panel;
        ...
        proto: {
            ...
            render: function(editor, output) {
                let env = CKEDITOR.env;

                let id = 'cke_' + this.id;
                let clickFn = CKEDITOR.tools.addFunction(function(el) {
                ...
                var instance = {
                    ...
                    combo: this,
                    focus: function() {
                        let element = CKEDITOR.document.getById(id).getChild(1);
                        element.focus();
                    },
                    execute: function(el) {
                        let _ = combo._;
                ...
                function updateState() {
                    ...
                    let state = this.modes[ editor.mode ] ? CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED;
                ...
                let keyDownFn = CKEDITOR.tools.addFunction(function(ev, element) {
                    ev = new CKEDITOR.dom.event(ev);

                    let keystroke = ev.getKeystroke();
                ...
                let focusFn = CKEDITOR.tools.addFunction(function() {
            ...
            createPanel: function(editor) {
                ...
                let panelDefinition = this._.panelDefinition,
            ...
            setValue: function(value, text) {
                ...
                let textElement = this.document.getById('cke_' + this.id + '_text');
                if (textElement) {
                    if (!(value || text)) {
                        text = this.label;
            ...
            setState: function(state) {
                ...
                let el = this.document.getById('cke_' + this.id);
