...
VISH.Status = function(V, $, undefined) {
  ...
  return{init:init, getDevice:getDevice, isExternalDomain:isExternalDomain, isEmbed:isEmbed, getContainer:getContainer, getContainerType:getContainerType, isScorm:isScorm, isExternalSite:isExternalSite, isVishSite:isVishSite, getProtocol:getProtocol, isPreview:isPreview, isPreviewInsertMode:isPreviewInsertMode, getIsUniqMode:getIsUniqMode, isOnline:isOnline, isSlaveMode:isSlaveMode, setSlaveMode:setSlaveMode, isPreventDefaultMode:isPreventDefaultMode, setPreventDefaultMode:setPreventDefaultMode, 
...
VISH.Recommendations = function(V, $, undefined) {
  ...
  var _getLOEPSettings = function() {
    try {
      ...
      confLOEPSettings.tokenURL = V.Utils.checkUrlProtocol(confLOEPSettings.domain);
