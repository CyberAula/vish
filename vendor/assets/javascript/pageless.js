...
(function ($, window) {
  ...
  var settings = {
    ...
    params: {},
    url: location.href,
    // deleted   loaderImage: "/assets/load.gif"
    method: 'get'
  };
  var container;
  var $container;
  ...
  var loaderHtml = function () {
    return settings.loaderHtml ||
      ...
      '<div class="spinner" alt="loading more results" style="margin:10px auto"><i class="fa fa-circle-o-notch fa-spin" alt="spinner"></i></div>' +
      '</div>';
  };
