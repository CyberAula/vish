...
(function() {
    ...
    if (!window.CKEDITOR)
        window.CKEDITOR = (function() {
            var a = {timestamp: 'D03G5XL',version: '3.6.6',revision: '7689',rnd: Math.floor(Math.random() * 900) + 100,_: {},status: 'unloaded',basePath: (function() {
    ...
    e.extend(d.window.prototype, {focus: function() {
        ...
        getViewPaneSize: function() {
            var g = this.$.document;
            var h=g?g.compatMode=='CSS1Compat':false;
            if(!g){
                var _width = 0;
                var _height = 0;
            } else {
                var _width = (h?g.documentElement.clientWidth:g.body.clientWidth)||0;
                var _height = (h?g.documentElement.clientHeight:g.body.clientHeight)||0;
            }
            return {
                width: _width,
                height: _height
    ...
    (function() {
        ...
        for (w in v)
            y.elements[w] = s();
        var z = {elementNames: [[/^cke:/, ''], [/^\?xml:namespace$/, '']],attributeNames: [[/^data-cke-(saved|pa)-/, ''], [/^data-cke-.*/, ''], ['hidefocus', '']],elements: {$: function(U) {
                    var V = U.attributes;
                    if (V) {
                        if (V['data-cke-temp'])
                            return false;
                    ...
                    t.contextMenu.addListener(function(E, F) {
                        ...
                        if (K && K.length) {
                            for (var Q = 0, R = K.length; Q < R; Q += 1) {
                                var S = 'scayt_suggestion_' + K[Q].replace(' ', '_'), T = (function(X, Y) {
                            ...
                            t.addMenuItem('scayt_nosuggest', {label: t.lang.scayt.noSuggestions ? t.lang.scayt.noSuggestions : t.lang.spellCheck.noSuggestions ? t.lang.spellCheck.noSuggestions : 'No suggestions',group: 'scayt_suggest',order: 1});
                            x.scayt_nosuggest = 2;
                        }
    ...
    (function() {
        var m = {editorFocus: false,modes: {wysiwyg: 1,source: 1}}, n = {readOnly: 1,exec: function(q) {
                q.container.focusNext(true, q.tabIndex);
            }}, o = {readOnly: 1,exec: function(q) {
    ...
    (function() {
        ...
        a.dialog = function(R, S) {
            ...
            function al(ar) {
                ...
                if (as == 9 || as == 2228224 + 9) {
                    ...
                    else if (ay.fire('cancel', {hide: true}).hide !== false)
                        ay.hide();
                    aa = 1;
                } else
                    return;
        ...
        function t(R, S, T) {
            ...
            S.on('keydown', function(U) {
                if (U.data.getKeystroke() in {32: 1,13: 1})
                    this.fire('click');
            });
            S.on('focus', function() {
                this.fire('mouseover');
        ...
        a.dialog.prototype = {destroy: function() {
                ...
                if (this._.currentTabId == R)
                    return;
                if (this.fire('selectPage', {page: R,currentPage: this._.currentTabId}) === true)
                    return;
        ...
        e.extend(a.dialog, {add: function(R, S) {
                ...
                var R = function(S, T) {
                    ...
                    return e.extend({id: 'ok',type: 'button',label: S.lang.common.ok,'class': 'cke_dialog_ui_button_ok',onClick: function(U) {
                            var V = U.data.dialog;
                            if (V.fire('ok', {hide: true}).hide !== false)
                                V.hide();
                        }}, T, true);
                };
                R.type = 'button';
                ...
                var R = function(S, T) {
                    ...
                    return e.extend({id: 'cancel',type: 'button',label: S.lang.common.cancel,'class': 'cke_dialog_ui_button_cancel',onClick: function(U) {
                            var V = U.data.dialog;
                            if (V.fire('cancel', {hide: true}).hide !== false)
                                V.hide();
                        }}, T, true);
                };
                R.type = 'button';
                ...
                p.on('mode', function() {
                    ...
                    e.setTimeout(function() {
                        var E = e.bind(function() {
                            var F = w.getFirst();
                            if (v.autoSize) {
                                var G = v.element.getDocument(), H = (b.webkit ? v.element : G.getBody()).$.scrollWidth;
                                if (c && b.quirks && H > 0)
                    ...
                    if (c) {
                        ...
                        function U(V) {
                            if (N) {
                                ...
                                var Z;
                                if (Y && Y.type && Y.type != 'Control' && (Z = Y.createRange()) && (Z = Z.parentElement()) && (Z = Z.nodeName) && Z.toLowerCase() in {input: 1,textarea: 1})
                                    return;
                                try {
                                    M = Y && X.getRanges()[0];
                                } catch (aa) {
                    ...
                    var F = function(G, H) {
                        ...
                        if (Q == -1 || Q == K.length - 1 && R < 0) {
                            ...
                            if (!S) {
                                L = K[K.length - 1];
                                if (L.nodeType != 3)
                                    return {container: I,offset: K.length};
                                else
                                    return {container: L,offset: L.nodeValue.length};
                            }
                            var V = K.length;
                            while (S > 0 && V > 0) {
                                M = K[--V];
                            ...
                            S = N.text.replace(/(\r\n|\r)/g, '\n').length;
                            if (!S)
                                return {container: I,offset: E(L) + (R > 0 ? 0 : 1)};
                            while (S > 0)
                                try {
    ...
    a.editor.prototype.resize = function(m, n, o, p) {
        var v = this;
        var q = v.container, r = a.document.getById('cke_contents_' + v.name), s = b.webkit && v.document && v.document.getWindow().$ && v.document.getWindow().$.frameElement, t = p ? q.getChild(1) : q;
